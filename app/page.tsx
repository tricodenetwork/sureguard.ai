...
const stats = [
    ...
    { title: "Threats Blocked", value: 2847, subtitle: "This month", color: "text-pink-600" },
    { title: "Response Time", value: 50, subtitle: "Average (ms)", color: "text-purple-600" },
    { title: "Active Users", value: 1200, subtitle: "Now", color: "text-green-600" },
    { title: "API Calls", value: 24567, subtitle: "Today", color: "text-blue-600" },
    { title: "Incidents", value: 3, subtitle: "This week", color: "text-red-600" },
    { title: "Devices Monitored", value: 876, subtitle: "Total", color: "text-yellow-600" },
    { title: "Alerts Sent", value: 432, subtitle: "Today", color: "text-indigo-600" },
    { title: "False Positives", value: 12, subtitle: "This month", color: "text-gray-600" },
    { title: "Blocked Countries", value: 5, subtitle: "Geo", color: "text-teal-600" },
]
        ...
        const interval = setInterval(() => {
            setData((prev) => [
                ...prev.slice(-9),
                {
                    ...
                    frauds: Math.floor(Math.random() * 10) + 1,
                },
            ])
        }, 3000)
                        ...
                        >
                            ...
                            >
                                <div className="text-center mb-6">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Automated Alerts</h4>
                                    <p className="text-gray-600 mb-4">
                                        Receive instant notifications for critical security events. Never miss an important update.
                                    </p>
