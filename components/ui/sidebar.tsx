    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating"
            ? "left-4 top-4 h-[calc(100vh-2rem)] rounded-lg border bg-sidebar shadow-lg"
            : "left-0 top-0 bg-sidebar",
          variant === "inset" ? "left-4 top-4 h-[calc(100vh-2rem)] rounded-lg border bg-sidebar shadow-lg" : "",
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:bg-sidebar group-data-[variant=floating]:shadow"
        >
          {children}
        </div>
      </div>
